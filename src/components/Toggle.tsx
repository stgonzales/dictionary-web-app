...
export const Toggle = () => {
  ...
  const [ isChecked, setIsChecked ] = createSignal(themeState.theme === 'dark')
  ...
  return (
    <div onClick={handleToogle} class="flex gap-5 cursor-pointer">
      <input type="checkbox" id="toogle" class='peer h-0 w-0 hidden' checked={isChecked()} onClick={handleToogle}/>
